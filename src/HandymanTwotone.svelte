...
<svg {width} {height} viewBox={viewBox.join(" ")} {...$$restProps} enable-background="new 0 0 24 24"><g><rect fill="none"/></g><g><g><g opacity=".3"><polygon points="8.66,14.64 4.41,18.88 5.12,19.59 9.36,15.34 9.36,15.34 8.66,14.64"/></g><g opacity=".3"><rect transform="matrix(0.7071 -0.7071 0.7071 0.7071 -7.0983 17.0848)" x="16.57" y="14.11"/></g><g>
