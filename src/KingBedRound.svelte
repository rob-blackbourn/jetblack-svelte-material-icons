...
<svg {width} {height} viewBox={viewBox.join(" ")} {...$$restProps} enable-background="new 0 0 24 24"><g><rect fill="none"/><rect fill="none"/></g><g><g><rect fill="none" x="6" y="7"/><rect fill="none" x="13" y="7"/>
