...
<svg {width} {height} viewBox={viewBox.join(" ")} {...$$restProps} enable-background="new 0 0 24 24"><g><rect fill="none"/></g><g><g><circle cx="6" cy="17" opacity=".3" r="2"/><circle cx="12" cy="7" opacity=".3" r="2"/><circle cx="18" cy="17" opacity=".3" r="2"/>
