...
<svg {width} {height} viewBox={viewBox.join(" ")} {...$$restProps} enable-background="new 0 0 24 24"><g><rect fill="none"/></g><g><g><rect opacity=".3" transform="matrix(0.9397 -0.342 0.342 0.9397 -1.6091 4.9556)" x="12.75" y="4.54"/><circle cx="10.5" cy="8" opacity=".3" r="1"/>
